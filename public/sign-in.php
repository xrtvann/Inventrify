    ...
    <div class="container bg-white rounded-lg w-[450px] shadow-sm py-2.5 px-10">
        ...
        <div class="form">
            <form action="" method="post">
                ...
                <div class="input-group flex justify-between mb-6">
                    ...
                    <div class="forgot-password-link">
                        <a href="#" class="text-sm text-blue-700">Forgot password ?</a>
                    </div>
                </div>
                ...
                <div class="register-link text-center">
                    <p class="text-sm text-gray-600">Don't have an account? <a href="sign-up.php"
